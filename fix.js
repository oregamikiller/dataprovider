...
var page = process.argv[2];
    ...
    rp.get({
        url: "http://psnine.com/psngame?ob=newest&pf=ps4&dlc=all&page=" + page,
        method: 'GET',
        encoding: 'utf-8',
        headers: {
            ...
            results.forEach(function (result, _i) {
                ...
                $(".list").find('tr').each(function (i, elem) {
                    ...
                    if (url) {
                        ...
                        console.log(trophy);
                        db.collection("gameTrophy").find({detailUrl: trophy.detailUrl, deep: 2}).toArray(function (err, docs) {
                            if (!err && docs.length < 1) {
