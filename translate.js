...
exports.translate = function(from, to, q, callback){
    var params = {
        appid: "20160216000012175",//开发者在百度开发者中心注册得到的授权API key
        from: from || 'auto',//源语言语种：语言代码或auto
        to: to || 'zh',//目标语言语种：语言代码或auto
        q: q || '',//待翻译内容
        salt: new Date().getTime()
    };

    params['sign'] = MD5(params["appid"]+q+params["salt"]+"T_VqdD7LZvFLmeKLtkxc")
    var data = querystring.stringify(params);//处理一下
    var options = {
        host: 'api.fanyi.baidu.com',
        port: 80,
        path: '/api/trans/vip/translate?' + data,//发送接口数据，GET请求
        method: 'GET'
    };
